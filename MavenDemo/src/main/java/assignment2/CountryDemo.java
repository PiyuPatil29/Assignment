package assignment2;
	...
	@Test
		public void m1() throws InterruptedException {
			...
			int column = driver.findElements(By.xpath("//th[contains(text(),'Company')]")).size();
			System.out.println("Columns are: " + column);

			WebElement table = driver.findElement(By.xpath("/html/body/table"));
			WebElement rowvalue = table.findElement(By.xpath("//td[contains(text(),'UK')]"));
			String rowText=rowvalue.getText();
			System.out.println("Rowtext is "+rowText);
		
			
			WebElement columnvalue=driver.findElement(By.xpath("//td[contains(text(),'Island Trading')]"));
